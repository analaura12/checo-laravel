                            ...
                            <div class="card" style="width: 13rem;" id="navbarsExampleDefault">
                                <figure class="figure">
                                    <a href="#restaurante" class="card-link" style="text-decoration:none"><img
                                            src="{{asset('images/restaurante.png')}}"
        ...
        <div class="card" style="width: 13rem;">
            <figure class="figure">
                <a href="#lanchonete" class="card-link" style="text-decoration:none"><img
                        src="{{asset('images/lanchonete.png')}}" class="figure-img img-fluid rounded"
                            alt="alternative">
                ...
                <li>
                    ...
                    <div class="card" style="width: 13rem;">
                        <figure class="figure">
                            <a href="#bar" class="card-link" style="text-decoration:none"><img
                                    src="{{asset('images/bar.png')}}" class="figure-img img-fluid rounded"
                                    alt="alternative">
                    ...
                    <div class="card" style="width: 13rem;">
                        <figure class="figure">
                            <a href="#cafeteria" class="card-link" style="text-decoration:none"><img
                                    src="{{asset('images/cafeteria.png')}}" class="figure-img img-fluid rounded"
                                    alt="alternative">
                ...
                <ul class="tipoComida">
                    <li>
                        ...
                        <div class="card" style="width: 12rem;" id="navbarsExampleDefault">
                            <figure class="figure">
                                <a href="#pizza" class="card-link" style="text-decoration:none"><img
                                        src="{{asset('images/pizza.png')}}" class="figure-img img-fluid rounded w-20"
                                        alt="alternative">
    ...
    <li>
        ...
        <div class="card" style="width: 12rem;">
            ...
            <li>
                ...
                <div class="card" style="width: 12rem;">
                    <figure class="figure">
                        <a href="#lanche" class="card-link" style="text-decoration:none"><img
                                src="{{asset('images/lanche.png')}}" class="figure-img img-fluid rounded"
                                alt="alternative">
            ...
            <li>
                ...
                <div class="card" style="width: 12rem;">
                    <figure class="figure">
                        <a href="#acai" class="card-link" style="text-decoration:none"><img
                                src="{{asset('images/acai.png')}}" class="figure-img img-fluid rounded"
                                alt="alternative">
            ...
            <li>
                ...
                <div class="card" style="width: 12rem;">
                    <figure class="figure">
                        <a href="#massa" class="card-link" style="text-decoration:none"><img
                                src="{{asset('images/massa.png')}}" class="figure-img img-fluid rounded"
                                alt="alternative">
            ...
            <li>
                ...
                <div class="card" style="width: 12rem;">
                    <figure class="figure">
                        <a href="#doce" class="card-link" style="text-decoration:none"><img
                                src="{{asset('images/doce.png')}}" class="figure-img img-fluid rounded"
                                alt="alternative">
            ...
            <div id="filtro" class="container text-center">
                <div class="input-group mb-2">
                    <div class="dropdown">
                        <button class="dropbtn" id="calendar">Ordenar por &nbsp<span
                    ...
                    <div class="dropdown">
                        <button class="dropbtn" id="calendar">Vale Refeição &nbsp<span
                                class="fas fa-chevron-down"></span></button>
                        <div class="dropdown-content">
                            <div class="card" class="dropdown-item">
                                <div class="input-group mb-2">
                    ...
                    <div class="dropdown">
                        <button class="dropbtn" id="calendar">Distância &nbsp<span
                                class="fas fa-chevron-down"></span></button>
                        <div class="dropdown-content">
                            <div class="card" class="dropdown-item">
                                <div class="input-group mb-2">
                    ...
                    <div class="card" style="width: 10rem;">
                        <figure class="figure">
                            <a href="#starbucks" class="card-link" style="text-decoration:none"><img
                                    src="{{asset('images/starbucks.png')}}" class="figure-img img-fluid rounded"
                                    alt="alternative">
            ...
            <div class="card" style="width: 10rem;">
                <figure class="figure">
                    <a href="#coronel" class="card-link" style="text-decoration:none"><img
                            src="{{asset('images/coronel.png')}}" class="figure-img img-fluid rounded"
                            alt="alternative">
        ...
        <li>
            ...
            <div class="card" style="width: 10rem;">
                <figure class="figure">
                    <a href="#losmex" class="card-link" style="text-decoration:none"><img
                            src="{{asset('images/losmex.png')}}" class="figure-img img-fluid rounded" alt="alternative">
        ...
        <li>
            ...
            <div class="card" style="width: 10rem;" id="navbarsExampleDefault">
                <figure class="figure">
                    <a href="#sukiya" class="card-link" style="text-decoration:none"><img
                            src="{{asset('images/sukiya.png')}}" class="figure-img img-fluid rounded w-20"
                            alt="alternative">
            ...
            <div class="card" style="width: 10rem;">
                <figure class="figure">
                    <a href="#outback" class="card-link" style="text-decoration:none"><img
                            src="{{asset('images/outback.png')}}" class="figure-img img-fluid rounded"
                            alt="alternative">
            ...
            <div class="card" style="width: 10rem;">
                <figure class="figure">
                    <a href="#speranza" class="card-link" style="text-decoration:none"><img
                            src="{{asset('images/speranza.png')}}" class="figure-img img-fluid rounded"
                            alt="alternative">
            ...
            <div class="card" style="width: 10rem;" id="navbarsExampleDefault">
                <figure class="figure">
                    <a href="#albadah" class="card-link" style="text-decoration:none"><img
                            src="{{asset('images/albadah.png')}}" class="figure-img img-fluid rounded w-20"
                            alt="alternative">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>Nada melhor do que chegar em um lugar, não pegar fila, não ter que esperar pela comida pois a
                            mesma
                            já estará quase pronta quando você chegar, certo? Parece um sonho? Pois com o CHE CO isso é
                            possível, você
                            pode ter sua refeição favorita e realizar encontros com os amigos no seu lugar favorito sem
                            ter que
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p>At ultrices mi tempus imperdiet nulla malesuada. Auctor elit sed vulputate mi sit
                                    amet. </p>
                                <a class="read-more no-line" href="">Saiba mais <span
                                        class="fas fa-long-arrow-alt-right"></span></a>
                            </div>
